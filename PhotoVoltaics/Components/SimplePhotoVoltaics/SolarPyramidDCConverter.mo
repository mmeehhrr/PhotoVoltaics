...
model SolarPyramidDCConverter "Solar pyramid with DC/DC converters"
  ...
  parameter Modelica.SIunits.Angle sunHeight=1.0471975511965976
  ...
  Modelica.SIunits.Current iGenerating1=module1.iGenerating
    "Negativ current of module 1 (generating)";
  Modelica.SIunits.Current iGenerating2=module2.iGenerating
    "Negativ current of module 2 (generating)";
  Modelica.SIunits.Current iGenerating3=module3.iGenerating
    "Negativ current of module 3 (generating)";
  Modelica.SIunits.Current iGenerating4=module4.iGenerating
  ...
  Modelica.SIunits.Power power=power1 + power2 + power3 + power4
    "Total power of all four modules";

  Modelica.SIunits.Power powerGenerating1=module1.powerGenerating
    "Negative power consumption (generating) of module 1";
  Modelica.SIunits.Power powerGenerating2=module2.powerGenerating
    "Negative power consumption (generating) of module 2";
  Modelica.SIunits.Power powerGenerating3=module3.powerGenerating
    "Negative power consumption (generating) of module 3";
  Modelica.SIunits.Power powerGenerating4=module4.powerGenerating
    "Negative power consumption (generating) of module 4";
  Modelica.SIunits.Power powerGenerating=powerGenerating1 +
