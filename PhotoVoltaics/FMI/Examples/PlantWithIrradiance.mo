within PhotoVoltaics.FMI.Examples;

model PlantWithIrradiance "Simple module supplies DC grid with maximum power tracker"
...
equation
  connect(groundDC.p, plant.n) annotation(
