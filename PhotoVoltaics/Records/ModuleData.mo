...
record ModuleData "Data of PV module"
  ...
  parameter Modelica.SIunits.Voltage BvCell=18 "Breakthrough cell voltage"
    annotation (Dialog(group="Breakthrough data"));
  parameter Modelica.SIunits.Current Ibv=1 "Breakthrough knee current"
    annotation (Dialog(group="Breakthrough data"));
  ...
  /*
                    ...
                    */
  final parameter Modelica.SIunits.Voltage VtCellRef=Modelica.Constants.k*
